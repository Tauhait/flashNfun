...
<meta name="viewport" content="width=device-width; initial-scale=.470; maximum-scale=.470; user-scalable=0;">
...
<button style="background-image: url( 'up.png' );;position:absolute;left:50px;background-size: 50px 50px;height:55px;width:55px;" onmousedown="moveup()" onmouseup="stopMove()" ontouchstart="moveup()" ontouchend="stopMove()"></button>
<button style="background-image: url( 'down.png' );;position:absolute;left:900px;background-size: 50px 50px;height:55px;width:55px;" onmousedown="movedown()" onmouseup="stopMove()" ontouchstart="movedown()" ontouchend="stopMove()"></button>
